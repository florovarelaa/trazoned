...
//         addEventListenersToPlayersButtons(players, moveBtnFunc, abilityBtnFunc)
//         this.setUiDisabled()
//     },
...
//                 createUiTag('div', `${idUnit}-step-${stepIndex}-container`, uiUnit, '', `Turn: ${stepIndex}`)
...
// function addEventListenersToPlayersButtons(players, moveBtnFunc, abilityBtnFunc) {
//     players.forEach( (player, playerIndex) => {
...
//                 moveButton.addEventListener('click', () => moveBtnFunc(unit, player.movements[0]))
...
//                     abilityButton.addEventListener('click', () => abilityBtnFunc(unit, ability))
//                 })
//             })
//         })
//     })
